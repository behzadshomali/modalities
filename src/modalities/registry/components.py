...
from modalities.loss_functions import CLMCrossEntropyLoss, MTPCrossEntropyLoss
...
COMPONENTS = [
    ...
    ComponentEntity("loss", "mtp_clm_cross_entropy_loss", MTPCrossEntropyLoss, MTPCrossEntropyLossConfig),
    # optmizers
