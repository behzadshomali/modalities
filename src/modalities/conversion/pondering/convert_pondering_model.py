"""
usage: convert_pondering_model.py [-h] [--num_testruns NUM_TESTRUNS] [--device_modalities DEVICE_MODALITIES]
                                   [--device_hf DEVICE_HF] modalities_config output_dir

Convert Pondering model checkpoint to Huggingface transformers format.
...
from modalities.conversion.pondering.conversion_code import transfer_model_code
from modalities.conversion.pondering.conversion_model import check_converted_model, convert_model_checkpoint
from modalities.conversion.gpt2.conversion_tokenizer import convert_tokenizer

logger = logging.getLogger(__name__)


def convert_pondering_model(
    ...
    """Takes a modalities pondering model and converts it to a Huggingface transformers model.
    ...
    # Handle tokenizer conversion (same as GPT2)
    ...
    hf_model.config.auto_map = {
        "AutoConfig": "configuration_pondering.PonderingModelConfig",
        "AutoModel": "modeling_pondering.PonderingModel",
        "AutoModelForCausalLM": "modeling_pondering.PonderingModelForCausalLM",
    }
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Convert Pondering model checkpoint to Huggingface transformers format.")
